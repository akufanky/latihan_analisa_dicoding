...
datetime_colums = ['order_date', 'delivery_date']
...
ax[0].set_title('Best Performing Product', loc='center', fintsize=50)
...
ax[1].set_title('Worst Performing Product', loc='center', fintsize=50)
...
with col3:
    ...
    st.metric('Average Recency (days)', value=avg_frequency)
...
ax[1].set_title('By Frequency (days)', loc='center', fontsize=50)
...
ax[2].set_title('By Monetary (days)', loc='center', fontsize=50)
